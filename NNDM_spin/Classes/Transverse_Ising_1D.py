...
# Implementation for the XYZ Heisenberg model on a 1-dimensional lattice
# In external field
...
class Transverse_Ising_1D(object):
    ...
    def __init__(self, X_site, Jz, gamma, field):
        ...
        self.gamma = gamma;
        self.i = 1j;
        self.model_name = 'Transv_ising_1D';
