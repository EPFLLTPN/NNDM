...
class Heisenberg_Carleo(object):
        
    def __init__(self, X_site, Jx, Jz, gamma, field):
        self.N_site = X_site;
        self.X_site = X_site;
        self.Y_site = 1;
        self.Jx = Jx;
...
# 
#         action = self.moveGen[self.rand.randint(0,6)];
#              
    ...
    def left_on_L(self, S_i, S_j):
        ...
        for col in range(self.X_site): #changed here
            ...
            lind_states.append([ None, [pos, right_neighbour] ]);
                ...
                # Off-diagonal term from external field Sx
            if self.field != 0:
                lind_elm[0] += (self.i)*S_i[pos]*self.field;
        ...
        def dissipator(pos, S_i, S_j):
            if S_i[pos] == S_j[pos]: 
                if S_i[pos] == 1:
                    ...
                    if self.rand.random_sample() < 0.3:
                        return pos, pos;
                    else:
                        return None, None;                                
            else:
